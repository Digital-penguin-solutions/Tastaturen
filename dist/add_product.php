...
?> <!DOCTYPE html> <?php include "partials/head.php";?> <html lang="swe"><head><title>Tastaturen add product</title><meta name="description" content="Tastaturen - Add product"></head> <?php 
