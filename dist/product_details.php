...
?> <!--Header --><header class="container-fluid pe_header" role="banner"><div class="row-fluid pe_header_container col-xs-12"><div class="pe_header_bg"> <?php
            ...
            ?> </div><div class="pe_header_text col-md-6 col-xs-12"><h1> <?php
                ...
                ?> </h1></div></div></header><!-- Show all the products--><section class="container-fluid pe_prod" role="main"><div class="row-fluid pe_prod"><div class="col-xs-12 pe_prod_container"><div class="pe_prod_container2 col-xs-11"> <?php
