...
if(!isset($functions_included)){
    ...
    function echo_admin_events($events){
        ...
        foreach ($events as $event) {
            ...
            ?> <div class="col-md-4 col-md-offset-<?php echo $offset ?> admin_product"><h1><?php echo $header ?></h1><img class="center_horizontally_css" src="data:image/jpeg;base64,<?php echo base64_encode( $main_image ); ?>" alt="No image chosen"><!--- EDIT BUTTON--> <a href="add_event?event_id=<?php echo $event_id?>" class="product_button product_edit_button"><p class="center_vertically_css">Edit</p></a><!--- DELETE BUTTON--> <a href="functions/delete_event?id=<?php echo $event_id?>" class="product_button product_delete_button"><p class="center_vertically_css">Delete</p></a></div> <?php
            $count++;
        }
    ...
    function echo_admin_media($posts){
        ...
        foreach ($posts as $post) {
            ...
            ?> <div class="col-md-4 col-md-offset-<?php echo $offset ?> admin_product"><h1><a href="index#Media"><?php echo $title ?></a></h1> <?php
               ...
               --><!--- DELETE BUTTON--> <a href="functions/delete_media?id=<?php echo $media_id?>" class="product_button product_delete_button"><p class="center_vertically_css">Delete</p></a></div> <?php
            $count++;
        }
