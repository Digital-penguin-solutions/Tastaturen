...
?> <!DOCTYPE html> <?php include "partials/head.php";?> <html lang="swe"><head><title>Tastaturen add media post</title><meta name="description" content="Tastaturen - Add media post"></head> <?php
