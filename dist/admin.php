...
?> <!DOCTYPE html><html lang="swe"><head><title>Admin</title></head><body class="col-xs-10"> <?php include "partials/nav.php" ?> <section class="admin_page col-xs-12"><div class="container-fluid full_height"><div class="row full_height"><div class="col-xs-10 col-xs-offset-1"><h1 class="admin_header">Admin page</h1> <?php
                if(isset($_GET['wrong'])){
                ...
                ?> <div class="manage_buttons_container col-xs-12"> <?php
                    ...
                    //}
                    //if(!isset($_GET['view'])){
                    ?> <a href="admin?view=media" class="manage_button col-xs-2 col-xs-offset-1"><p>Manage media posts</p></a><a href="admin?view=products" class="manage_button col-xs-2 col-xs-offset-1"><p>Manage products</p></a><a href="admin?view=links" class="manage_button col-xs-2 col-xs-offset-1"><p>Manage links</p></a><a href="admin?view=events" class="manage_button col-xs-2 col-xs-offset-1"><p>Manage events</p></a> <?php
                    //}
                ...
                ?> <h1 class="products_type">Media posts</h1><div class="row admin_all_products_container"> <?php
                    ...
                    if(isset($_SESSION['admin'])){
                        ?> <div class="a_btn_container col-xs-12"><a href="add_product.php" class="add_product_button col-xs-5 col-xs-offset-1">Add a new product </a><a href="add_media.php" class="add_product_button col-xs-5 col-xs-offset-1">Add new media post </a><a href="add_link.php" class="add_product_button col-xs-5 col-xs-offset-1">Add new link </a><a href="add_event.php" class="add_product_button col-xs-5 col-xs-offset-1">Add new event </a><a href="admin?change_password=" class="add_product_button col-xs-5 col-xs-offset-1">Change password </a><a href="functions/logout" class="add_product_button col-xs-5 col-xs-offset-1">Logout</a></div> <?php
                    }
                    else {
